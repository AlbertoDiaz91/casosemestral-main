# Generated by Django 4.0.1 on 2022-05-17 01:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(max_length=20)),
                ('imagen', models.ImageField(null=True, upload_to='perro')),
                ('fecha_nacimiento', models.DateField()),
                ('raza', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.tipoperro')),
            ],
            options={
                'db_table': 'db_perro',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('codigo', models.CharField(max_length=9, primary_key=True, serialize=False)),
                ('nombre', models.CharField(max_length=20)),
                ('imagen', models.ImageField(null=True, upload_to='gato')),
                ('fecha_nacimiento', models.DateField()),
                ('raza_gato', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.tipogato')),
            ],
            options={
                'db_table': 'db_gato',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('codigo', models.CharField(max_length=9, primary_key=True, serialize=False)),
                ('nombre', models.CharField(max_length=20)),
                ('imagen', models.ImageField(null=True, upload_to='exotico')),
                ('fecha_nacimiento', models.DateField()),
                ('especie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.tipoexotico')),
            ],
            options={
                'db_table': 'db_exotico',
            },
